...
function onCreate()
    precacheImage('b31') -- change "b31" to your correct file
    precacheImage('b32') -- change "b31" to your correct file
end
...
function onCreatePost()
        makeLuaSprite('iconnameP2', 'b31', getProperty('iconP2.x'), getProperty('iconP2.y')) -- change "b31" to your correct file
        ...
        makeLuaSprite('iconnameloseP2', 'b32', getProperty('iconP2.x'), getProperty('iconP2.y')) -- change "b32" to your correct file
